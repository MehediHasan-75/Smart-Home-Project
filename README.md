...
- [Smart Home](#smart-home)
  ...
  - [Objective](#objective)
  - [Home (Front Side)](#home-front-side)
  - [Home (Back Side)](#home-back-side)
  - [Hardware Components](#hardware-components)
  - [Software Requirements](#software-requirements)
  - [Procedure to Build the Home](#procedure-to-build-the-home)
  - [Wiring and Connections](#wiring-and-connections)
    - [Pin Details for Each Component](#pin-details-for-each-component)
    - [Relay and NodeMCU Pin Details](#relay-and-nodemcu-pin-details)
  - [Programming the Arduino](#programming-the-arduino)
  - [Programming the ESP8266 NodeMCU](#programming-the-esp8266-nodemcu)
